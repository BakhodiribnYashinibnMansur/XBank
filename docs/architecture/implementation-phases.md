# Implementatsiya Faza Ketma-ketligi

## Faza 1: Foundation + Git
...
## Faza 2: Identity + Session + 2FA + RBAC + Security
...
## Faza 3: Account + Event Sourcing + CQRS
...
## Faza 4: Transfer + Saga + AML + Fraud
...
## Faza 8: Test UI + Test Client
22. Web UI (HTML/JS/Tailwind), CLI test client
23. Swagger docs, seed data
24. Integration + Security + Performance testlar
