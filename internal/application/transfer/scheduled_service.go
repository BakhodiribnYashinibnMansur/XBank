...
func (s *ScheduledService) Schedule(ctx context.Context, userID, fromAccountID, toAccountID string, amount int64, currency shared.Currency, description string, executeAt time.Time) (_ *transfer.ScheduledTransfer, err error) {
