...
var (
	ErrFraudDetected = domain.NewDomainError("FRAUD_DETECTED", "suspicious activity detected")
	ErrAMLBlocked    = domain.NewDomainError("AML_BLOCKED", "transaction blocked by AML screening")
)
