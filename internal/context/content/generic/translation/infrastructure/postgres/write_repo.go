...
func (r *WriteRepo) Save(ctx context.Context, t *entity.Translation) error {
...
func (r *WriteRepo) Update(ctx context.Context, t *entity.Translation) error {
...
func (r *WriteRepo) FindByID(ctx context.Context, id string) (*entity.Translation, error) {
...
func (r *WriteRepo) FindByKeyAndLanguage(ctx context.Context, key string, lang entity.Language) (*entity.Translation, error) {
	t := &entity.Translation{}
	err := r.pool.QueryRow(ctx,
