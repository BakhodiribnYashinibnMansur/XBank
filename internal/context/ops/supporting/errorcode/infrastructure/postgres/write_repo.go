...
func (r *WriteRepo) Save(ctx context.Context, e *entity.ErrorCode) error {
...
func (r *WriteRepo) Update(ctx context.Context, e *entity.ErrorCode) error {
...
func (r *WriteRepo) FindByID(ctx context.Context, id string) (*entity.ErrorCode, error) {
	e := &entity.ErrorCode{}
...
func (r *WriteRepo) FindByCode(ctx context.Context, code string) (*entity.ErrorCode, error) {
	e := &entity.ErrorCode{}
	err := r.pool.QueryRow(ctx,
		`SELECT id, code, message_en, message_uz, message_ru, category, severity, http_status, retryable, suggestion, created_at, updated_at
